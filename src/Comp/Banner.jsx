...
const Banner = () => {
    return (
        <div
            className="hero min-h-[55vh] rounded-md bg-cover bg-center"
        ...
        >
            ...
            <div className="hero-content flex flex-col-reverse lg:flex-row-reverse justify-center items-center p-4 lg:p-8">
                <div className="w-80 lg:w-1/2 rounded-lg mb-4 lg:mb-0">
                    <Swap />
                </div>
